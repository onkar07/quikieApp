...
&lt;/script&gt;</code></pre> 
    ...
    <div role="tabpanel" class="tab-pane" id="dual-demo">
      ...
      <div class="row">
        <div class="col-xs-12">  
          <pre><code class="language-javascript">&lt;div id="dual1-grid" class="row"&gt;
...
&lt;/script&gt;</code></pre> 
    ...
    <div role="tabpanel" class="tab-pane" id="custom-demo">
      <div class="row" id="custom-grid"> 
      </div>
      <div class="row">
        <div class="col-xs-12">  
          <pre><code class="language-javascript">&lt;!-- Gridstrap can work without a Bootstrap grid --&gt;
&lt;div id="custom-grid"&gt;
...
&lt;/script&gt;</code></pre> 
    ...
    <div role="tabpanel" class="tab-pane" id="api-demo">
      ...
      <div class="row"> 
        <div class="col-xs-6 col-md-4">
          <div class="checkbox">
            <label>
              <input type="checkbox" id="swap-mode"/> Swap mode
            </label>
          </div>
          <div class="checkbox">
            <label>
              <input type="checkbox" id="rearrange-mode" checked="checked"/> Rearrange on drag
            </label>
          </div>
          <div>
            <button class="btn btn-default btn-lg" id="move">Move random cell</button>
          </div>
          <div>
            <br/>
             <a href="http://github.com/rosspi/gridstrap.js">More on github...</a>
          </div>
        </div>
      </div>
    </div> 
...
<script src="http://cdnjs.cloudflare.com/ajax/libs/prism/1.6.0/prism.js"></script>
